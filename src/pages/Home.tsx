...
import { TrendingUp, Shield, DollarSign, Target, Clock, Users, ArrowRight, CheckCircle, Star } from "lucide-react";
  ...
  return <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                  <Button size="lg" className="bg-primary hover:bg-primary-dark text-primary-foreground px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300 animate-glow" asChild>
                    <a href="https://www.empirefundedcheckout.com" target="_blank" rel="noopener noreferrer">
                      Get Funded Now
                    </a>
                  </Button>
                  <Button variant="outline" size="lg" className="border-primary/30 hover:bg-primary/10 px-8 py-4 text-lg text-primary hover:text-primary transition-all duration-300" asChild>
                    <Link to="/challenges">
                      View Challenges
                    </Link>
                  </Button>
        ...
        <div className="absolute bottom-0 left-0 w-full bg-card/50 backdrop-blur-sm border-t border-border/50 py-4 overflow-hidden">
          <div className="animate-ticker flex items-center gap-12 whitespace-nowrap">
            {[...payoutTickers, ...payoutTickers].map((payout, index) => <div key={index} className="flex items-center gap-4 text-sm">
        ...
        <div className="container px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => <div key={index} className="relative bg-card/60 backdrop-blur-sm border border-border/50 rounded-xl p-6 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl group overflow-hidden animate-slide-up" style={{
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              animationDelay: `${index * 150}ms`
                  ...
                  {/* Connection line */}
                  {index < steps.length - 1 && <div className="hidden lg:block absolute top-12 left-1/2 w-full h-0.5 bg-gradient-to-r from-primary/50 to-primary/20 translate-x-8 z-0"></div>}
            ...
            <div className="text-center mt-16">
              <Button size="lg" className="bg-gradient-to-r from-primary to-primary-glow hover:from-primary-dark hover:to-primary text-primary-foreground px-12 py-4 text-lg font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 animate-glow" asChild>
                <a href="https://www.empirefundedcheckout.com" target="_blank" rel="noopener noreferrer">
          ...
          <div className="max-w-5xl mx-auto text-center">
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button size="lg" className="bg-gradient-to-r from-warning to-secondary hover:from-warning/90 hover:to-secondary/90 text-warning-foreground px-10 py-4 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300" asChild>
                  <Link to="/affiliates">
                    Join Affiliate Program
                  </Link>
                </Button>
                
                <Button variant="outline" size="lg" className="border-primary/30 text-primary hover:bg-primary/10 px-8 py-4 text-lg transition-all duration-300" asChild>
                  <Link to="/challenges">
                    Learn More
                  </Link>
                </Button>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container px-4 text-center">
          ...
          <Button size="lg" asChild className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 text-lg px-8 py-6">
            <a href="https://www.empirefundedcheckout.com" target="_blank" rel="noopener noreferrer">
              Get Funded Now
